package com.besolutions.drnour.Scenarios.ScenarioFAQ.Pattrens;
...
public class FAQ_Group2_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FAQ_Group2_Adapter(RecyclerView recyclerView, List<FAQ_Group1_Model> faqList) {
