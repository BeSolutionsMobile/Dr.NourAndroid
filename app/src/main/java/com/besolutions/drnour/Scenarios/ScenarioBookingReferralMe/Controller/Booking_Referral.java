package com.besolutions.drnour.Scenarios.ScenarioBookingReferralMe.Controller;
...
public class Booking_Referral extends Fragment {
    ...
    {
        view = inflater.inflate(R.layout.booking_referral_me, container, false);
        ((MainActivity) getActivity()).getSupportActionBar().setTitle("Booking Referred me");
        ...
        RecyclerView recyclerView = (RecyclerView)view.findViewById(R.id.rcyBookingReferral);
